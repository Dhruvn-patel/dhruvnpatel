...
export default function About() {
  ...
  return (
    <section id="about" className="py-20 bg-muted/30 relative overflow-hidden">
      {/* Background gradient */}
      <div className="absolute -z-10 top-1/3 right-0 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-purple-500/10 to-pink-500/5 blur-3xl" />
      <div className="absolute -z-10 bottom-1/3 left-0 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-pink-500/10 to-purple-500/5 blur-3xl" />
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 gradient-text">Who I Am</h2>
